module.exports = {
	'default settings should be development':function(test) {
		test.expect(1);
	...
	'settings should be set to process.env.NODE_ENV if provided':function(test) {
		test.expect(1);
	...
	'mongoDbUrls should be correct depending on env':function(test) {
		test.expect(3);
		process.env.NODE_ENV = 'production';
